# Security policies of Libbulletjme

To report a security vulnerability in the Libbulletjme project,
...
At the present time, the Libbulletjme project does not have a bug-bounty program.

To suggest improvements to these policies,
[open an issue at GitHub](https://github.com/stephengold/Libbulletjme/issues/new).
